...
public class BlsCodesDao {
    ...
    public BlsCodesDao() {
        AREA_CODES_AVERAGE_PRICE = ImmutableList.<AreaItemCode>builder()
                ...
                .add(new AreaItemCode("A000", "City size A"))
                .add(new AreaItemCode("A100", "Northeast Size A"))
                ...
                .add(new AreaItemCode("A200", "Midwest Size A"))
                ...
                .add(new AreaItemCode("A300", "South Size A"))
                ...
                .add(new AreaItemCode("A400", "West Size A"))
                ...
                .add(new AreaItemCode("B000", "City size B"))
                .add(new AreaItemCode("B100", "Northeast size B"))
                .add(new AreaItemCode("B200", "North Central size B"))
                .add(new AreaItemCode("B300", "South size B"))
                .add(new AreaItemCode("B400", "West size B"))
                .add(new AreaItemCode("C000", "City size C"))
                .add(new AreaItemCode("C100", "Northeast size C"))
                .add(new AreaItemCode("C200", "North Central size C"))
                .add(new AreaItemCode("C300", "South size C"))
                .add(new AreaItemCode("C400", "West size C"))
                .add(new AreaItemCode("D000", "City size D"))
                .add(new AreaItemCode("D100", "Northeast size D"))
                .add(new AreaItemCode("D200", "Midwest Size D"))
                .add(new AreaItemCode("D300", "South Size D"))
                .add(new AreaItemCode("D400", "West size D"))
                .add(new AreaItemCode("X000", "City size B/C"))
                .add(new AreaItemCode("X100", "Northeast Size B/C"))
                .add(new AreaItemCode("X200", "Midwest Size B/C"))
                .add(new AreaItemCode("X300", "South Size B/C"))
                .add(new AreaItemCode("X400", "West Size B/C"))
                .build();
